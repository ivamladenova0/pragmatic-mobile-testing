...
public class Client {
    ...
    private static final String EMU_NAME = "Nexus5Api23";
    ...
    public static void startAppiumClient() {
        ...
        capabilities.setCapability(AndroidMobileCapabilityType.AVD, EMU_NAME);
        // If  you want to test on real android device remove the line above and use
        // capabilities.setCapability(MobileCapabilityType.UDID, "<id of your device>");
